const starredCells = document.querySelectorAll(".starred");
starredCells.forEach((cell) => {
  const star = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  star.classList.add("star");
  star.setAttribute("viewBox", "0 0 47.94 47.94");
  star.setAttribute("version", "1.1");
  star.setAttribute("transform", `rotate(${Math.random() * 90})`);
